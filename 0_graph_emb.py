...
# # 生成 edge_new.csv 文件
# all_edges = [ (s, t) for s, t, _ in G.edges ]  # 去除额外的元数据
...
# original_edges = filtered_edges_df[['source_id', 'target_id', 'relation']]

# edge_new_df = pd.concat([original_edges, edge_new_df], ignore_index=True)
# edge_new_df = edge_new_df.drop_duplicates(subset=['source_id', 'target_id', 'relation'], keep='first')
